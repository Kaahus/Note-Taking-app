...
data class Note(
    ...
    /**
     * Simple function to convert a timestamp to a human-readable form
     */
    fun readableTime(): String {
        val dateFormat = SimpleDateFormat("MMM dd, yyy hh:mm a", Locale.getDefault())
    ...
    companion object {
        /**
         * Gets alist of basic (pre_defined) notes
         */
